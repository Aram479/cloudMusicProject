...
import { formatLyric } from "@/utils/player/format";
import { gotoArtistDetail, gotoAlbumDetail } from "@/utils/player/routerPush";
import { useStore } from "vuex";
import { IPlaySong } from "@/components/player/types/player";
import { IlyricUser } from "@/components/player/types/lyric";
